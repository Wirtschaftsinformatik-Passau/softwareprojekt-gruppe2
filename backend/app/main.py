...
from .routers import energieberatende, users, auth, admin, netzbetreiber, haushalt, solarteur
...
app.include_router(haushalt.router)
app.include_router(solarteur.router)
