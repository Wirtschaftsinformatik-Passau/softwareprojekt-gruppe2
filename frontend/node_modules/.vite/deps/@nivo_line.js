...
function colors_default(specifier) {
  var n6 = specifier.length / 6 | 0, colors2 = new Array(n6), i5 = 0;
  while (i5 < n6)
    colors2[i5] = "#" + specifier.slice(i5 * 6, ++i5 * 6);
  return colors2;
}
...
function rgba(r5, g5, b5, a4) {
  if (a4 <= 0)
    r5 = g5 = b5 = NaN;
  return new Rgb(r5, g5, b5, a4);
}
...
function hslConvert(o4) {
  ...
  if (o4 instanceof Hsl)
    return o4;
  o4 = o4.rgb();
  var r5 = o4.r / 255, g5 = o4.g / 255, b5 = o4.b / 255, min = Math.min(r5, g5, b5), max = Math.max(r5, g5, b5), h3 = NaN, s3 = max - min, l3 = (max + min) / 2;
  if (s3) {
    if (r5 === max)
      h3 = (g5 - b5) / s3 + (g5 < b5) * 6;
    else if (g5 === max)
      ...
      h3 = (r5 - g5) / s3 + 4;
    s3 /= l3 < 0.5 ? max + min : 2 - max - min;
    h3 *= 60;
  } else {
    s3 = l3 > 0 && l3 < 1 ? 0 : h3;
  }
  return new Hsl(h3, s3, l3, o4.opacity);
}
...
function labConvert(o4) {
  ...
  if (!(o4 instanceof Rgb))
    o4 = rgbConvert(o4);
  var r5 = rgb2lrgb(o4.r), g5 = rgb2lrgb(o4.g), b5 = rgb2lrgb(o4.b), y3 = xyz2lab((0.2225045 * r5 + 0.7168786 * g5 + 0.0606169 * b5) / Yn), x4, z2;
  if (r5 === g5 && g5 === b5)
    x4 = z2 = y3;
  else {
    x4 = xyz2lab((0.4360747 * r5 + 0.3850649 * g5 + 0.1430804 * b5) / Xn);
    z2 = xyz2lab((0.0139322 * r5 + 0.0971045 * g5 + 0.7141733 * b5) / Zn);
  }
  return new Lab(116 * y3 - 16, 500 * (x4 - y3), 200 * (y3 - z2), o4.opacity);
}
function lab(l3, a4, b5, opacity) {
  return arguments.length === 1 ? labConvert(l3) : new Lab(l3, a4, b5, opacity == null ? 1 : opacity);
}
function Lab(l3, a4, b5, opacity) {
  this.l = +l3;
  this.a = +a4;
...
define_default(Lab, lab, extend(Color, {
  ...
  rgb: function() {
    var y3 = (this.l + 16) / 116, x4 = isNaN(this.a) ? y3 : y3 + this.a / 500, z2 = isNaN(this.b) ? y3 : y3 - this.b / 200;
    x4 = Xn * lab2xyz(x4);
    y3 = Yn * lab2xyz(y3);
    z2 = Zn * lab2xyz(z2);
    return new Rgb(
      lrgb2rgb(3.1338561 * x4 - 1.6168667 * y3 - 0.4906146 * z2),
      lrgb2rgb(-0.9787684 * x4 + 1.9161415 * y3 + 0.033454 * z2),
      lrgb2rgb(0.0719453 * x4 - 0.2289914 * y3 + 1.4052427 * z2),
      this.opacity
    );
  }
}));
...
function hcl(h3, c4, l3, opacity) {
  return arguments.length === 1 ? hclConvert(h3) : new Hcl(h3, c4, l3, opacity == null ? 1 : opacity);
}
function Hcl(h3, c4, l3, opacity) {
  this.h = +h3;
  this.c = +c4;
...
function cubehelixConvert(o4) {
  ...
  if (!(o4 instanceof Rgb))
    o4 = rgbConvert(o4);
  var r5 = o4.r / 255, g5 = o4.g / 255, b5 = o4.b / 255, l3 = (BC_DA * b5 + ED * r5 - EB * g5) / (BC_DA + ED - EB), bl = b5 - l3, k5 = (E * (g5 - l3) - C * bl) / D, s3 = Math.sqrt(k5 * k5 + bl * bl) / (E * l3 * (1 - l3)), h3 = s3 ? Math.atan2(k5, bl) * degrees - 120 : NaN;
  return new Cubehelix(h3 < 0 ? h3 + 360 : h3, s3, l3, o4.opacity);
}
function cubehelix(h3, s3, l3, opacity) {
  return arguments.length === 1 ? cubehelixConvert(h3) : new Cubehelix(h3, s3, l3, opacity == null ? 1 : opacity);
}
function Cubehelix(h3, s3, l3, opacity) {
  this.h = +h3;
  this.s = +s3;
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb: function() {
    ...
    return new Rgb(
      255 * (l3 + a4 * (A * cosh + B * sinh)),
      255 * (l3 + a4 * (C * cosh + D * sinh)),
      255 * (l3 + a4 * (E * cosh)),
      this.opacity
    );
  }
...
function sinebow_default(t9) {
  var x4;
  t9 = (0.5 - t9) * Math.PI;
  c2.r = 255 * (x4 = Math.sin(t9)) * x4;
  c2.g = 255 * (x4 = Math.sin(t9 + pi_1_3)) * x4;
  c2.b = 255 * (x4 = Math.sin(t9 + pi_2_3)) * x4;
  return c2 + "";
}
...
function ramp(range) {
  var n6 = range.length;
  return function(t9) {
    return range[Math.max(0, Math.min(n6 - 1, Math.floor(t9 * n6)))];
  };
}
...
function qe() {
  return qe = Object.assign || function(e7) {
    for (var r5 = 1; r5 < arguments.length; r5++) {
      var n6 = arguments[r5];
      for (var t9 in n6)
        Object.prototype.hasOwnProperty.call(n6, t9) && (e7[t9] = n6[t9]);
    }
    return e7;
...
function Re(e7, r5) {
  ...
  for (var n6 = 0, t9 = new Array(r5); n6 < r5; n6++)
    t9[n6] = e7[n6];
  return t9;
}
function Se(e7, r5) {
  ...
  if (Array.isArray(e7) || (n6 = function(e8, r6) {
    ...
    var t9 = 0;
    return function() {
      return t9 >= e7.length ? { done: true } : { done: false, value: e7[t9++] };
    };
  }
    ...
    if (function(e8) {
      ...
      if (Array.isArray(e7.modifiers)) {
        for (var o4, i5 = [], u2 = function() {
          ...
          u2();
        return 0 === i5.length ? t9 : function(e8) {
...
var fr = function(e7, r5) {
  ...
  if (Array.isArray(e7)) {
    var t9 = ordinal(e7), o4 = function(e8) {
      return t9(n6(e8));
    };
  ...
  if ((0, import_isPlainObject.default)(e7)) {
    ...
    if (function(e8) {
      ...
      if (Je(e7.scheme)) {
        ...
        var c4 = ordinal($e[e7.scheme][e7.size || 9]), l3 = function(e8) {
          return c4(n6(e8));
        };
        return l3.scale = c4, l3;
      }
    }
...
raf.setTimeout = (handler, ms) => {
  ...
  let cancel = () => {
    let i5 = timeouts.findIndex((t9) => t9.cancel == cancel);
    if (~i5)
...
function update() {
  ...
  if (count) {
    eachSafely(timeouts.splice(0, count), (t9) => t9.handler());
    __raf.count -= count;
  }
  onStartQueue.flush();
...
function useTransition(data, props, deps) {
  ...
  useOnce(() => () => each(usedTransitions.current, (t9) => {
    if (t9.expired) {
  ...
  each(transitions, (t9, i5) => {
    ...
    to2 = callProp(to2, t9.item, i5);
    to2 = is.obj(to2) ? inferTo(to2) : {
      to: to2
    };
    if (!to2.config) {
      const config2 = propsConfig || defaultProps.config;
      to2.config = callProp(config2, t9.item, i5, phase);
    }
    delay += trail;
    ...
    payload.onResolve = (result) => {
      ...
      const t10 = transitions2.find((t11) => t11.key === key);
      if (!t10)
        return;
      if (result.cancelled && t10.phase != TransitionPhase.UPDATE) {
        return;
      }
      if (t10.ctrl.idle) {
        const idle = transitions2.every((t11) => t11.ctrl.idle);
        if (t10.phase == TransitionPhase.LEAVE) {
          const expiry = callProp(expires, t10.item);
          if (expiry !== false) {
            const expiryMs = expiry === true ? 0 : expiry;
            t10.expired = true;
            if (!idle && expiryMs > 0) {
              if (expiryMs <= 2147483647)
                t10.expirationId = setTimeout(forceUpdate, expiryMs);
              return;
            }
          }
        }
        if (idle && transitions2.some((t11) => t11.expired)) {
          forceUpdate();
        }
      }
    };
  ...
  const renderTransitions = (render) => React3.createElement(React3.Fragment, null, transitions.map((t9, i5) => {
    const {
      springs
    } = changes.get(t9) || t9.ctrl;
    const elem = render(_extends3({}, springs), t9.item, t9, i5);
...
function getKeys(items, {
  ...
  if (keys === null) {
    ...
    return items.map((item) => {
      const t9 = prevTransitions && prevTransitions.find((t10) => t10.item === item && t10.phase !== TransitionPhase.LEAVE && !reused.has(t10));
      if (t9) {
        reused.add(t9);
        return t9.key;
      }
...
var FluidTransform = class extends FluidValue {
  ...
  _get() {
    ...
    each(this.inputs, (input, i5) => {
      ...
      const [t9, id] = this.transforms[i5](is.arr(arg1) ? arg1 : input.map(getFluidValue));
      transform += " " + t9;
...
var Q = function(n6) {
  var t9 = n6.format, r5 = void 0 === t9 ? "native" : t9, e7 = n6.precision, a4 = void 0 === e7 ? "millisecond" : e7, u2 = n6.useUTC, c4 = void 0 === u2 || u2, f4 = L(a4);
  return function(n7) {
    if (void 0 === n7)
      return n7;
    if ("native" === r5 || n7 instanceof Date)
      return f4(n7);
    var t10 = c4 ? utcParse(r5) : timeParse(r5);
    return f4(t10(n7));
  };
};
var W = function(n6, t9, r5, e7) {
  var a4, i5, o4, c4, f4 = n6.min, d2 = void 0 === f4 ? 0 : f4, s3 = n6.max, l3 = void 0 === s3 ? "auto" : s3, m3 = n6.stacked, v5 = void 0 !== m3 && m3, y3 = n6.reverse, p5 = void 0 !== y3 && y3, h3 = n6.clamp, g5 = void 0 !== h3 && h3, x4 = n6.nice, k5 = void 0 !== x4 && x4;
  "auto" === d2 ? a4 = true === v5 ? null != (i5 = t9.minStacked) ? i5 : 0 : t9.min : a4 = d2;
  "auto" === l3 ? o4 = true === v5 ? null != (c4 = t9.maxStacked) ? c4 : 0 : t9.max : o4 = l3;
...
var Y = function(n6, t9, r5) {
  var e7 = point().range([0, r5]).domain(t9.all);
  return e7.type = "point", e7;
};
var _ = function(n6, t9, r5, e7) {
  var a4 = n6.round, i5 = void 0 === a4 || a4, o4 = band().range("x" === e7 ? [0, r5] : [r5, 0]).domain(t9.all).round(i5);
  return nn(o4);
};
var nn = function(n6) {
  var t9 = n6;
...
var tn = function(n6, t9, r5) {
  var e7, a4, i5 = n6.format, o4 = void 0 === i5 ? "native" : i5, u2 = n6.precision, c4 = void 0 === u2 ? "millisecond" : u2, f4 = n6.min, l3 = void 0 === f4 ? "auto" : f4, m3 = n6.max, v5 = void 0 === m3 ? "auto" : m3, y3 = n6.useUTC, p5 = void 0 === y3 || y3, h3 = n6.nice, g5 = void 0 !== h3 && h3, x4 = Q({ format: o4, precision: c4, useUTC: p5 });
  e7 = "auto" === l3 ? x4(t9.min) : "native" !== o4 ? x4(l3) : l3, a4 = "auto" === v5 ? x4(t9.max) : "native" !== o4 ? x4(v5) : v5;
...
var rn2 = function(n6, t9, r5, e7) {
  var a4, i5 = n6.base, o4 = void 0 === i5 ? 10 : i5, u2 = n6.min, c4 = void 0 === u2 ? "auto" : u2, f4 = n6.max, d2 = void 0 === f4 ? "auto" : f4;
  ...
  s3 = "auto" === c4 ? t9.min : c4, m3 = "auto" === d2 ? t9.max : d2;
  var y3 = log().domain([s3, m3]).rangeRound("x" === e7 ? [0, r5] : [r5, 0]).base(o4).nice();
  return y3.type = "log", y3;
};
var en = function(n6, t9, r5, e7) {
  var a4, i5, o4 = n6.constant, u2 = void 0 === o4 ? 1 : o4, c4 = n6.min, f4 = void 0 === c4 ? "auto" : c4, d2 = n6.max, s3 = void 0 === d2 ? "auto" : d2, l3 = n6.reverse, v5 = void 0 !== l3 && l3;
  a4 = "auto" === f4 ? t9.min : f4, i5 = "auto" === s3 ? t9.max : s3;
...
var on = function(n6, t9) {
  return n6 === t9;
};
var un = function(n6, t9) {
  return n6.getTime() === t9.getTime();
};
function cn(n6, t9, r5, e7) {
  switch (n6.type) {
    case "linear":
      return W(n6, t9, r5, e7);
    case "point":
      return Y(0, t9, r5);
    case "band":
      return _(n6, t9, r5, e7);
    case "time":
      return tn(n6, t9, r5);
    case "log":
      return rn2(n6, t9, r5, e7);
    case "symlog":
      return en(n6, t9, r5, e7);
    default:
      throw new Error("invalid scale spec");
  }
}
var fn = function(n6, t9, r5) {
  var e7;
  if ("stacked" in r5 && r5.stacked) {
    var a4 = n6.data["x" === t9 ? "xStacked" : "yStacked"];
    return null == a4 ? null : r5(a4);
  }
  return null != (e7 = r5(n6.data[t9])) ? e7 : null;
};
var dn = function(n6, t9, r5, e7, a4) {
  ...
  "stacked" in t9 && true === t9.stacked && vn(o4, i5), "stacked" in r5 && true === r5.stacked && yn(o4, i5);
  var u2 = cn(t9, o4.x, e7, "x"), c4 = cn(r5, o4.y, a4, "y"), f4 = i5.map(function(n7) {
    return $({}, n7, { data: n7.data.map(function(n8) {
      return $({}, n8, { position: { x: fn(n8, "x", u2), y: fn(n8, "y", c4) } });
    }) });
  });
  return $({}, o4, { series: f4, xScale: u2, yScale: c4 });
};
var sn = function(n6, t9, r5) {
  return { x: ln(n6, "x", t9), y: ln(n6, "y", r5) };
};
var ln = function(a4, i5, o4, u2) {
  var c4 = void 0 === u2 ? {} : u2, f4 = c4.getValue, d2 = void 0 === f4 ? function(n6) {
    return n6.data[i5];
  } : f4, s3 = c4.setValue, l3 = void 0 === s3 ? function(n6, t9) {
    n6.data[i5] = t9;
  } : s3;
  if ("linear" === o4.type)
  ...
  switch (a4.forEach(function(n6) {
    ...
    case "time":
      var p5 = (0, import_uniqBy.default)(v5, function(n6) {
        return n6.getTime();
      }).slice(0).sort(function(n6, t9) {
        return t9.getTime() - n6.getTime();
      }).reverse();
...
var mn = function(n6, t9, r5) {
  var i5 = an(n6), o4 = [];
  t9[i5].all.forEach(function(t10) {
    var u2 = (0, import_isDate.default)(t10) ? un : on, c4 = [];
    r5.forEach(function(r6) {
      var a4 = r6.data.find(function(n7) {
        return u2(n7.data[i5], t10);
      }), f4 = null, d2 = null;
      if (void 0 !== a4) {
      ...
      c4.push(d2), null !== d2 && o4.push(d2);
    });
  }), t9[n6].minStacked = Math.min.apply(Math, o4), t9[n6].maxStacked = Math.max.apply(Math, o4);
};
var vn = function(n6, t9) {
  return mn("x", n6, t9);
};
var yn = function(n6, t9) {
  return mn("y", n6, t9);
};
var pn = function(n6) {
  var t9 = n6.bandwidth();
...
var kn = function(n6, t9) {
  ...
  if ("string" == typeof t9 && "useUTC" in n6) {
    ...
    if (r5) {
      ...
      if ("day" === a4) {
        var o4, u2, c4 = n6.domain(), f4 = c4[0], d2 = c4[1], s3 = new Date(d2);
  ...
  if ("ticks" in n6) {
    if (void 0 === t9)
      return n6.ticks();
    if ("number" == typeof (m3 = t9) && isFinite(m3) && Math.floor(m3) === m3)
      return n6.ticks(t9);
  }
  var m3;
  return n6.domain();
...
function v() {
  return v = Object.assign || function(t9) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var i5 = arguments[e7];
      for (var n6 in i5)
        Object.prototype.hasOwnProperty.call(i5, n6) && (t9[n6] = i5[n6]);
    }
    return t9;
  }, v.apply(this, arguments);
}
var p = function(t9) {
  var e7, i5 = t9.axis, n6 = t9.scale, r5 = t9.ticksPosition, a4 = t9.tickValues, o4 = t9.tickSize, s3 = t9.tickPadding, c4 = t9.tickRotation, f4 = t9.engine, x4 = void 0 === f4 ? "svg" : f4, d2 = kn(n6, a4), y3 = yi[x4], g5 = "bandwidth" in n6 ? pn(n6) : n6, k5 = { lineX: 0, lineY: 0 }, h3 = { textX: 0, textY: 0 }, p5 = "object" == typeof document && "rtl" === document.dir, b5 = y3.align.center, P4 = y3.baseline.center;
  return "x" === i5 ? (e7 = function(t10) {
    var e8;
    return { x: null != (e8 = g5(t10)) ? e8 : 0, y: 0 };
  }, k5.lineY = o4 * ("after" === r5 ? 1 : -1), h3.textY = (o4 + s3) * ("after" === r5 ? 1 : -1), P4 = "after" === r5 ? y3.baseline.top : y3.baseline.bottom, 0 === c4 ? b5 = y3.align.center : "after" === r5 && c4 < 0 || "before" === r5 && c4 > 0 ? (b5 = y3.align[p5 ? "left" : "right"], P4 = y3.baseline.center) : ("after" === r5 && c4 > 0 || "before" === r5 && c4 < 0) && (b5 = y3.align[p5 ? "right" : "left"], P4 = y3.baseline.center)) : (e7 = function(t10) {
    var e8;
    return { x: 0, y: null != (e8 = g5(t10)) ? e8 : 0 };
  }, k5.lineX = o4 * ("after" === r5 ? 1 : -1), h3.textX = (o4 + s3) * ("after" === r5 ? 1 : -1), b5 = "after" === r5 ? y3.align.left : y3.align.right), { ticks: d2.map(function(t10) {
    return v({ key: "number" == typeof t10 || "string" == typeof t10 ? t10 : "" + t10, value: t10 }, e7(t10), k5, h3);
  }), textAlign: b5, textBaseline: P4 };
};
var b = function(t9, e7) {
  if (void 0 === t9 || "function" == typeof t9)
    return t9;
  if ("time" === e7.type) {
...
var P = function(t9) {
  var e7, i5 = t9.width, n6 = t9.height, r5 = t9.scale, a4 = t9.axis, o4 = t9.values, l3 = (e7 = o4, Array.isArray(e7) ? o4 : void 0) || kn(r5, o4), s3 = "bandwidth" in r5 ? pn(r5) : r5, c4 = "x" === a4 ? l3.map(function(t10) {
    var e8, i6;
    return { key: "" + t10, x1: null != (e8 = s3(t10)) ? e8 : 0, x2: null != (i6 = s3(t10)) ? i6 : 0, y1: 0, y2: n6 };
  }) : l3.map(function(t10) {
    var e8, n7;
    return { key: "" + t10, x1: 0, x2: i5, y1: null != (e8 = s3(t10)) ? e8 : 0, y2: null != (n7 = s3(t10)) ? n7 : 0 };
  });
  return c4;
};
var S = (0, import_react5.memo)(function(t9) {
  var e7, n6 = t9.value, a4 = t9.format, o4 = t9.lineX, l3 = t9.lineY, c4 = t9.onClick, f4 = t9.textBaseline, x4 = t9.textAnchor, d2 = t9.animatedProps, u2 = Vt(), m3 = null != (e7 = null == a4 ? void 0 : a4(n6)) ? e7 : n6, k5 = (0, import_react5.useMemo)(function() {
    var t10 = { opacity: d2.opacity };
    return c4 ? { style: v({}, t10, { cursor: "pointer" }), onClick: function(t11) {
      return c4(t11, m3);
    } } : { style: t10 };
  }, [d2.opacity, c4, m3]);
...
var T = (0, import_react5.memo)(function(e7) {
  var n6 = e7.axis, l3 = e7.scale, f4 = e7.x, x4 = void 0 === f4 ? 0 : f4, d2 = e7.y, u2 = void 0 === d2 ? 0 : d2, m3 = e7.length, k5 = e7.ticksPosition, h3 = e7.tickValues, P4 = e7.tickSize, T4 = void 0 === P4 ? 5 : P4, w4 = e7.tickPadding, A3 = void 0 === w4 ? 5 : w4, O4 = e7.tickRotation, X4 = void 0 === O4 ? 0 : O4, Y4 = e7.format, W3 = e7.renderTick, B4 = void 0 === W3 ? S : W3, z2 = e7.legend, V3 = e7.legendPosition, C4 = void 0 === V3 ? "end" : V3, R = e7.legendOffset, j2 = void 0 === R ? 0 : R, E3 = e7.onClick, D2 = e7.ariaHidden, q = Vt(), F = (0, import_react5.useMemo)(function() {
    return b(Y4, l3);
  }, [Y4, l3]), H2 = p({ axis: n6, scale: l3, ticksPosition: k5, tickValues: h3, tickSize: T4, tickPadding: A3, tickRotation: X4 }), N3 = H2.ticks, I = H2.textAlign, G = H2.textBaseline, J2 = null;
  if (void 0 !== z2) {
    var K4, L2 = 0, M = 0, Q3 = 0;
    "y" === n6 ? (Q3 = -90, L2 = j2, "start" === C4 ? (K4 = "start", M = m3) : "middle" === C4 ? (K4 = "middle", M = m3 / 2) : "end" === C4 && (K4 = "end")) : (M = j2, "start" === C4 ? K4 = "start" : "middle" === C4 ? (K4 = "middle", L2 = m3 / 2) : "end" === C4 && (K4 = "end", L2 = m3)), J2 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + L2 + ", " + M + ") rotate(" + Q3 + ")", textAnchor: K4, style: v({ dominantBaseline: "central" }, q.axis.legend.text), children: z2 });
  }
  var U = tt(), Z = U.animate, $2 = U.config, _2 = useSpring({ transform: "translate(" + x4 + "," + u2 + ")", lineX2: "x" === n6 ? m3 : 0, lineY2: "x" === n6 ? 0 : m3, config: $2, immediate: !Z }), tt2 = useTransition(N3, { keys: function(t9) {
    return t9.key;
  }, initial: function(t9) {
    return { opacity: 1, transform: "translate(" + t9.x + "," + t9.y + ")", textTransform: "translate(" + t9.textX + "," + t9.textY + ") rotate(" + X4 + ")" };
  }, from: function(t9) {
    return { opacity: 0, transform: "translate(" + t9.x + "," + t9.y + ")", textTransform: "translate(" + t9.textX + "," + t9.textY + ") rotate(" + X4 + ")" };
  }, enter: function(t9) {
    return { opacity: 1, transform: "translate(" + t9.x + "," + t9.y + ")", textTransform: "translate(" + t9.textX + "," + t9.textY + ") rotate(" + X4 + ")" };
  }, update: function(t9) {
    return { opacity: 1, transform: "translate(" + t9.x + "," + t9.y + ")", textTransform: "translate(" + t9.textX + "," + t9.textY + ") rotate(" + X4 + ")" };
  }, leave: { opacity: 0 }, config: $2, immediate: !Z });
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: _2.transform, "aria-hidden": D2, children: [tt2(function(e8, i5, n7, r5) {
    return t4.createElement(B4, v({ tickIndex: r5, format: F, rotate: X4, textBaseline: G, textAnchor: I, animatedProps: e8 }, i5, E3 ? { onClick: E3 } : {}));
...
var A2 = import_prop_types2.default.shape(w);
var O = ["top", "right", "bottom", "left"];
var X2 = (0, import_react5.memo)(function(t9) {
  var e7 = t9.xScale, i5 = t9.yScale, n6 = t9.width, r5 = t9.height, a4 = { top: t9.top, right: t9.right, bottom: t9.bottom, left: t9.left };
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: O.map(function(t10) {
    var o4 = a4[t10];
    if (!o4)
      return null;
    var l3 = "top" === t10 || "bottom" === t10;
    return (0, import_jsx_runtime.jsx)(T, v({}, o4, { axis: l3 ? "x" : "y", x: "right" === t10 ? n6 : 0, y: "bottom" === t10 ? r5 : 0, scale: l3 ? e7 : i5, length: l3 ? n6 : r5, ticksPosition: "top" === t10 || "left" === t10 ? "before" : "after" }), t10);
  }) });
});
var Y2 = (0, import_react5.memo)(function(t9) {
  var e7 = t9.animatedProps, i5 = Vt();
  return (0, import_jsx_runtime.jsx)(animated.line, v({}, e7, i5.grid.line));
});
var W2 = (0, import_react5.memo)(function(t9) {
  var e7 = t9.lines, i5 = tt(), r5 = i5.animate, a4 = i5.config, l3 = useTransition(e7, { keys: function(t10) {
    return t10.key;
  ...
  return (0, import_jsx_runtime.jsx)("g", { children: l3(function(t10, e8) {
    return (0, import_react5.createElement)(Y2, v({}, e8, { key: e8.key, animatedProps: t10 }));
  }) });
});
var B2 = (0, import_react5.memo)(function(t9) {
  var e7 = t9.width, n6 = t9.height, r5 = t9.xScale, a4 = t9.yScale, o4 = t9.xValues, l3 = t9.yValues, s3 = (0, import_react5.useMemo)(function() {
    return !!r5 && P({ width: e7, height: n6, scale: r5, axis: "x", values: o4 });
  }, [r5, o4, e7, n6]), c4 = (0, import_react5.useMemo)(function() {
...
var z = function(t9, e7) {
  var i5, n6 = e7.axis, r5 = e7.scale, a4 = e7.x, o4 = void 0 === a4 ? 0 : a4, l3 = e7.y, s3 = void 0 === l3 ? 0 : l3, c4 = e7.length, x4 = e7.ticksPosition, d2 = e7.tickValues, u2 = e7.tickSize, m3 = void 0 === u2 ? 5 : u2, y3 = e7.tickPadding, g5 = void 0 === y3 ? 5 : y3, k5 = e7.tickRotation, h3 = void 0 === k5 ? 0 : k5, v5 = e7.format, b5 = e7.legend, P4 = e7.legendPosition, S4 = void 0 === P4 ? "end" : P4, T4 = e7.legendOffset, w4 = void 0 === T4 ? 0 : T4, A3 = e7.theme, O4 = p({ axis: n6, scale: r5, ticksPosition: x4, tickValues: d2, tickSize: m3, tickPadding: g5, tickRotation: h3, engine: "canvas" }), X4 = O4.ticks, Y4 = O4.textAlign, W3 = O4.textBaseline;
  t9.save(), t9.translate(o4, s3), t9.textAlign = Y4, t9.textBaseline = W3, t9.font = (A3.axis.ticks.text.fontWeight ? A3.axis.ticks.text.fontWeight + " " : "") + A3.axis.ticks.text.fontSize + "px " + A3.axis.ticks.text.fontFamily, (null != (i5 = A3.axis.domain.line.strokeWidth) ? i5 : 0) > 0 && (t9.lineWidth = Number(A3.axis.domain.line.strokeWidth), t9.lineCap = "square", A3.axis.domain.line.stroke && (t9.strokeStyle = A3.axis.domain.line.stroke), t9.beginPath(), t9.moveTo(0, 0), t9.lineTo("x" === n6 ? c4 : 0, "x" === n6 ? 0 : c4), t9.stroke());
  var B4 = "function" == typeof v5 ? v5 : function(t10) {
    return "" + t10;
  };
  if (X4.forEach(function(e8) {
    var i6;
    (null != (i6 = A3.axis.ticks.line.strokeWidth) ? i6 : 0) > 0 && (t9.lineWidth = Number(A3.axis.ticks.line.strokeWidth), t9.lineCap = "square", A3.axis.ticks.line.stroke && (t9.strokeStyle = A3.axis.ticks.line.stroke), t9.beginPath(), t9.moveTo(e8.x, e8.y), t9.lineTo(e8.x + e8.lineX, e8.y + e8.lineY), t9.stroke());
    var n7 = B4(e8.value);
    t9.save(), t9.translate(e8.x + e8.textX, e8.y + e8.textY), t9.rotate(ui(h3)), A3.axis.ticks.text.fill && (t9.fillStyle = A3.axis.ticks.text.fill), t9.fillText(String(n7), 0, 0), t9.restore();
  }), void 0 !== b5) {
    var z2 = 0, V3 = 0, C4 = 0, R = "center";
    "y" === n6 ? (C4 = -90, z2 = w4, "start" === S4 ? (R = "start", V3 = c4) : "middle" === S4 ? (R = "center", V3 = c4 / 2) : "end" === S4 && (R = "end")) : (V3 = w4, "start" === S4 ? R = "start" : "middle" === S4 ? (R = "center", z2 = c4 / 2) : "end" === S4 && (R = "end", z2 = c4)), t9.translate(z2, V3), t9.rotate(ui(C4)), t9.font = (A3.axis.legend.text.fontWeight ? A3.axis.legend.text.fontWeight + " " : "") + A3.axis.legend.text.fontSize + "px " + A3.axis.legend.text.fontFamily, A3.axis.legend.text.fill && (t9.fillStyle = A3.axis.legend.text.fill), t9.textAlign = R, t9.textBaseline = "middle", t9.fillText(b5, 0, 0);
  }
  t9.restore();
};
var V = function(t9, e7) {
  var i5 = e7.xScale, n6 = e7.yScale, r5 = e7.width, a4 = e7.height, o4 = e7.top, l3 = e7.right, s3 = e7.bottom, c4 = e7.left, f4 = e7.theme, x4 = { top: o4, right: l3, bottom: s3, left: c4 };
  O.forEach(function(e8) {
    var o5 = x4[e8];
    if (!o5)
      return null;
    var l4 = "top" === e8 || "bottom" === e8, s4 = "top" === e8 || "left" === e8 ? "before" : "after", c5 = l4 ? i5 : n6, d2 = b(o5.format, c5);
    z(t9, v({}, o5, { axis: l4 ? "x" : "y", x: "right" === e8 ? r5 : 0, y: "bottom" === e8 ? a4 : 0, scale: c5, format: d2, length: l4 ? r5 : a4, ticksPosition: s4, theme: f4 }));
  });
};
var C2 = function(t9, e7) {
  ...
  P({ width: i5, height: n6, scale: r5, axis: a4, values: o4 }).forEach(function(e8) {
    t9.beginPath(), t9.moveTo(e8.x1, e8.y1), t9.lineTo(e8.x2, e8.y2), t9.stroke();
  });
};
...
var m = function(e7) {
  var i5 = e7.x, n6 = e7.y, o4 = e7.size, r5 = e7.fill, l3 = e7.opacity, a4 = void 0 === l3 ? 1 : l3, c4 = e7.borderWidth, s3 = void 0 === c4 ? 0 : c4, d2 = e7.borderColor;
...
function p2() {
  return p2 = Object.assign || function(t9) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var i5 = arguments[e7];
      for (var n6 in i5)
        Object.prototype.hasOwnProperty.call(i5, n6) && (t9[n6] = i5[n6]);
...
var k2 = function(t9) {
  var e7, i5 = t9.direction, n6 = t9.itemsSpacing, o4 = t9.padding, r5 = t9.itemCount, l3 = t9.itemWidth, a4 = t9.itemHeight;
  if ("number" != typeof o4 && ("object" != typeof (e7 = o4) || Array.isArray(e7) || null === e7))
    throw new Error("Invalid property padding, must be one of: number, object");
  var c4 = "number" == typeof o4 ? { top: o4, right: o4, bottom: o4, left: o4 } : p2({}, b2, o4), s3 = c4.left + c4.right, d2 = c4.top + c4.bottom, h3 = l3 + s3, g5 = a4 + d2, m3 = (r5 - 1) * n6;
  return "row" === i5 ? h3 = l3 * r5 + m3 + s3 : "column" === i5 && (g5 = a4 * r5 + m3 + d2), { width: h3, height: g5, padding: c4 };
};
var x = function(t9) {
  var e7 = t9.anchor, i5 = t9.translateX, n6 = t9.translateY, o4 = t9.containerWidth, r5 = t9.containerHeight, l3 = t9.width, a4 = t9.height, c4 = i5, s3 = n6;
  switch (e7) {
    case "top":
      c4 += (o4 - l3) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c4 += (o4 - l3) / 2, s3 += (r5 - a4) / 2;
  }
  return { x: c4, y: s3 };
};
var S2 = function(t9) {
  var e7, i5, n6, o4, r5, l3, a4 = t9.direction, c4 = t9.justify, s3 = t9.symbolSize, d2 = t9.symbolSpacing, h3 = t9.width, g5 = t9.height;
  switch (a4) {
    case "left-to-right":
      e7 = 0, i5 = (g5 - s3) / 2, o4 = g5 / 2, l3 = "central", c4 ? (n6 = h3, r5 = "end") : (n6 = s3 + d2, r5 = "start");
      break;
    case "right-to-left":
      e7 = h3 - s3, i5 = (g5 - s3) / 2, o4 = g5 / 2, l3 = "central", c4 ? (n6 = 0, r5 = "start") : (n6 = h3 - s3 - d2, r5 = "end");
      break;
    case "top-to-bottom":
      e7 = (h3 - s3) / 2, i5 = 0, n6 = h3 / 2, r5 = "middle", c4 ? (o4 = g5, l3 = "alphabetic") : (o4 = s3 + d2, l3 = "text-before-edge");
      break;
    case "bottom-to-top":
      e7 = (h3 - s3) / 2, i5 = g5 - s3, n6 = h3 / 2, r5 = "middle", c4 ? (o4 = 0, l3 = "text-before-edge") : (o4 = g5 - s3 - d2, l3 = "alphabetic");
  }
...
var B3 = function(i5) {
  var n6, r5, l3, c4, h3, g5, m3, f4, u2, v5, y3, b5 = i5.x, k5 = i5.y, x4 = i5.width, A3 = i5.height, W3 = i5.data, z2 = i5.direction, C4 = void 0 === z2 ? "left-to-right" : z2, B4 = i5.justify, w4 = void 0 !== B4 && B4, X4 = i5.textColor, Y4 = i5.background, H2 = void 0 === Y4 ? "transparent" : Y4, E3 = i5.opacity, j2 = void 0 === E3 ? 1 : E3, T4 = i5.symbolShape, L2 = void 0 === T4 ? "square" : T4, M = i5.symbolSize, F = void 0 === M ? 16 : M, P4 = i5.symbolSpacing, R = void 0 === P4 ? 8 : P4, q = i5.symbolBorderWidth, V3 = void 0 === q ? 0 : q, D2 = i5.symbolBorderColor, G = void 0 === D2 ? "transparent" : D2, I = i5.onClick, N3 = i5.onMouseEnter, _2 = i5.onMouseLeave, J2 = i5.toggleSerie, K4 = i5.effects, Q3 = (0, import_react6.useState)({}), U = Q3[0], Z = Q3[1], $2 = Vt(), tt2 = (0, import_react6.useCallback)(function(t9) {
    if (K4) {
      var e7 = K4.filter(function(t10) {
        return "hover" === t10.on;
      }).reduce(function(t10, e8) {
        return p2({}, t10, e8.style);
      }, {});
      Z(e7);
    }
    null == N3 || N3(W3, t9);
  }, [N3, W3, K4]), et2 = (0, import_react6.useCallback)(function(t9) {
    if (K4) {
      var e7 = K4.filter(function(t10) {
        return "hover" !== t10.on;
      }).reduce(function(t10, e8) {
    ...
    null == _2 || _2(W3, t9);
  }, [_2, W3, K4]), it2 = S2({ direction: C4, justify: w4, symbolSize: null != (n6 = U.symbolSize) ? n6 : F, symbolSpacing: R, width: x4, height: A3 }), nt = it2.symbolX, ot = it2.symbolY, rt = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct = it2.labelAlignment, st = [I, N3, _2, J2].some(function(t9) {
    return void 0 !== t9;
  }), dt = "function" == typeof L2 ? L2 : O2[L2];
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + b5 + "," + k5 + ")", style: { opacity: null != (r5 = U.itemOpacity) ? r5 : j2 }, children: [(0, import_jsx_runtime2.jsx)("rect", { width: x4, height: A3, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t9) {
    null == I || I(W3, t9), null == J2 || J2(W3.id);
...
var w2 = function(e7) {
  var i5 = e7.data, n6 = e7.x, o4 = e7.y, r5 = e7.direction, l3 = e7.padding, a4 = void 0 === l3 ? 0 : l3, c4 = e7.justify, s3 = e7.effects, d2 = e7.itemWidth, h3 = e7.itemHeight, g5 = e7.itemDirection, m3 = void 0 === g5 ? "left-to-right" : g5, f4 = e7.itemsSpacing, u2 = void 0 === f4 ? 0 : f4, v5 = e7.itemTextColor, p5 = e7.itemBackground, y3 = void 0 === p5 ? "transparent" : p5, b5 = e7.itemOpacity, x4 = void 0 === b5 ? 1 : b5, S4 = e7.symbolShape, A3 = e7.symbolSize, W3 = e7.symbolSpacing, z2 = e7.symbolBorderWidth, C4 = e7.symbolBorderColor, O4 = e7.onClick, w4 = e7.onMouseEnter, X4 = e7.onMouseLeave, Y4 = e7.toggleSerie, H2 = k2({ itemCount: i5.length, itemWidth: d2, itemHeight: h3, itemsSpacing: u2, direction: r5, padding: a4 }).padding, E3 = "row" === r5 ? d2 + u2 : 0, j2 = "column" === r5 ? h3 + u2 : 0;
  return (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + n6 + "," + o4 + ")", children: i5.map(function(e8, i6) {
    return (0, import_jsx_runtime2.jsx)(B3, { data: e8, x: i6 * E3 + H2.left, y: i6 * j2 + H2.top, width: d2, height: h3, direction: m3, justify: c4, effects: s3, textColor: v5, background: y3, opacity: x4, symbolShape: S4, symbolSize: A3, symbolSpacing: W3, symbolBorderWidth: z2, symbolBorderColor: C4, onClick: O4, onMouseEnter: w4, onMouseLeave: X4, toggleSerie: Y4 }, i6);
  }) });
};
var X3 = function(e7) {
  var i5 = e7.data, n6 = e7.containerWidth, o4 = e7.containerHeight, r5 = e7.translateX, l3 = void 0 === r5 ? 0 : r5, a4 = e7.translateY, c4 = void 0 === a4 ? 0 : a4, s3 = e7.anchor, d2 = e7.direction, h3 = e7.padding, g5 = void 0 === h3 ? 0 : h3, m3 = e7.justify, f4 = e7.itemsSpacing, u2 = void 0 === f4 ? 0 : f4, v5 = e7.itemWidth, p5 = e7.itemHeight, y3 = e7.itemDirection, b5 = e7.itemTextColor, S4 = e7.itemBackground, A3 = e7.itemOpacity, W3 = e7.symbolShape, z2 = e7.symbolSize, C4 = e7.symbolSpacing, O4 = e7.symbolBorderWidth, B4 = e7.symbolBorderColor, X4 = e7.onClick, Y4 = e7.onMouseEnter, H2 = e7.onMouseLeave, E3 = e7.toggleSerie, j2 = e7.effects, T4 = k2({ itemCount: i5.length, itemsSpacing: u2, itemWidth: v5, itemHeight: p5, direction: d2, padding: g5 }), L2 = T4.width, M = T4.height, F = x({ anchor: s3, translateX: l3, translateY: c4, containerWidth: n6, containerHeight: o4, width: L2, height: M }), P4 = F.x, R = F.y;
  return (0, import_jsx_runtime2.jsx)(w2, { data: i5, x: P4, y: R, direction: d2, padding: g5, justify: m3, effects: j2, itemsSpacing: u2, itemWidth: v5, itemHeight: p5, itemDirection: y3, itemTextColor: b5, itemBackground: S4, itemOpacity: A3, symbolShape: W3, symbolSize: z2, symbolSpacing: C4, symbolBorderWidth: O4, symbolBorderColor: B4, onClick: X4, onMouseEnter: Y4, onMouseLeave: H2, toggleSerie: "boolean" == typeof E3 ? void 0 : E3 });
};
var Y3 = { start: "left", middle: "center", end: "right" };
var H = function(t9, e7) {
  var i5 = e7.data, n6 = e7.containerWidth, o4 = e7.containerHeight, r5 = e7.translateX, l3 = void 0 === r5 ? 0 : r5, a4 = e7.translateY, c4 = void 0 === a4 ? 0 : a4, s3 = e7.anchor, d2 = e7.direction, h3 = e7.padding, g5 = void 0 === h3 ? 0 : h3, m3 = e7.justify, f4 = void 0 !== m3 && m3, u2 = e7.itemsSpacing, v5 = void 0 === u2 ? 0 : u2, p5 = e7.itemWidth, y3 = e7.itemHeight, b5 = e7.itemDirection, A3 = void 0 === b5 ? "left-to-right" : b5, W3 = e7.itemTextColor, z2 = e7.symbolSize, C4 = void 0 === z2 ? 16 : z2, O4 = e7.symbolSpacing, B4 = void 0 === O4 ? 8 : O4, w4 = e7.theme, X4 = k2({ itemCount: i5.length, itemWidth: p5, itemHeight: y3, itemsSpacing: v5, direction: d2, padding: g5 }), H2 = X4.width, E3 = X4.height, j2 = X4.padding, T4 = x({ anchor: s3, translateX: l3, translateY: c4, containerWidth: n6, containerHeight: o4, width: H2, height: E3 }), L2 = T4.x, M = T4.y, F = "row" === d2 ? p5 + v5 : 0, P4 = "column" === d2 ? y3 + v5 : 0;
  t9.save(), t9.translate(L2, M), t9.font = w4.legends.text.fontSize + "px " + (w4.legends.text.fontFamily || "sans-serif"), i5.forEach(function(e8, i6) {
    var n7, o5, r6 = i6 * F + j2.left, l4 = i6 * P4 + j2.top, a5 = S2({ direction: A3, justify: f4, symbolSize: C4, symbolSpacing: B4, width: p5, height: y3 }), c5 = a5.symbolX, s4 = a5.symbolY, d3 = a5.labelX, h4 = a5.labelY, g6 = a5.labelAnchor, m4 = a5.labelAlignment;
    t9.fillStyle = null != (n7 = e8.color) ? n7 : "black", t9.fillRect(r6 + c5, l4 + s4, C4, C4), t9.textAlign = Y3[g6], "central" === m4 && (t9.textBaseline = "middle"), t9.fillStyle = null != (o5 = null != W3 ? W3 : w4.legends.text.fill) ? o5 : "black", t9.fillText(String(e8.label), r6 + d3, l4 + h4);
  }), t9.restore();
};
...
function v3() {
  return v3 = Object.assign || function(t9) {
...
var m2 = function(t9, o4) {
  return "translate(" + t9 + "px, " + o4 + "px)";
};
var g3 = (0, import_react7.memo)(function(t9) {
  var i5, n6 = t9.position, r5 = t9.anchor, e7 = t9.children, l3 = Vt(), d2 = tt(), p5 = d2.animate, f4 = d2.config, g5 = Ft(), b5 = g5[0], w4 = g5[1], T4 = (0, import_react7.useRef)(false), C4 = void 0, E3 = false, P4 = w4.width > 0 && w4.height > 0, N3 = Math.round(n6[0]), V3 = Math.round(n6[1]);
  P4 && ("top" === r5 ? (N3 -= w4.width / 2, V3 -= w4.height + 14) : "right" === r5 ? (N3 += 14, V3 -= w4.height / 2) : "bottom" === r5 ? (N3 -= w4.width / 2, V3 += 14) : "left" === r5 ? (N3 -= w4.width + 14, V3 -= w4.height / 2) : "center" === r5 && (N3 -= w4.width / 2, V3 -= w4.height / 2), C4 = { transform: m2(N3, V3) }, T4.current || (E3 = true), T4.current = [N3, V3]);
  var j2 = useSpring({ to: C4, config: f4, immediate: !p5 || E3 }), O4 = v3({}, x2, l3.tooltip, { transform: null != (i5 = j2.transform) ? i5 : m2(N3, V3) });
  return (0, import_jsx_runtime3.jsx)(animated.div, { ref: b5, style: O4, children: e7 });
});
g3.displayName = "TooltipWrapper";
var b3 = (0, import_react7.memo)(function(t9) {
  var o4 = t9.size, i5 = void 0 === o4 ? 12 : o4, n6 = t9.color, r5 = t9.style;
  return (0, import_jsx_runtime3.jsx)("span", { style: v3({ display: "block", width: i5, height: i5, background: n6 }, void 0 === r5 ? {} : r5) });
});
var w3 = (0, import_react7.memo)(function(t9) {
  var o4, i5 = t9.id, n6 = t9.value, r5 = t9.format, e7 = t9.enableChip, l3 = void 0 !== e7 && e7, a4 = t9.color, c4 = t9.renderContent, h3 = Vt(), u2 = Xt(r5);
...
var C3 = (0, import_react7.memo)(function(t9) {
  var o4, i5 = t9.title, n6 = t9.rows, r5 = void 0 === n6 ? [] : n6, e7 = t9.renderContent, l3 = Vt();
  return r5.length ? (o4 = "function" == typeof e7 ? e7() : (0, import_jsx_runtime3.jsxs)("div", { children: [i5 && i5, (0, import_jsx_runtime3.jsx)("table", { style: v3({}, T3, l3.tooltip.table), children: (0, import_jsx_runtime3.jsx)("tbody", { children: r5.map(function(t10, o5) {
    return (0, import_jsx_runtime3.jsx)("tr", { children: t10.map(function(t11, o6) {
      return (0, import_jsx_runtime3.jsx)("td", { style: l3.tooltip.tableCell, children: t11 }, o6);
    }) }, o5);
  }) }) })] }), (0, import_jsx_runtime3.jsx)("div", { style: l3.tooltip.container, children: o4 })) : null;
});
C3.displayName = "TableTooltip";
var E2 = (0, import_react7.memo)(function(t9) {
  var o4 = t9.x0, n6 = t9.x1, r5 = t9.y0, e7 = t9.y1, l3 = Vt(), u2 = tt(), d2 = u2.animate, p5 = u2.config, f4 = (0, import_react7.useMemo)(function() {
...
var P2 = (0, import_react7.memo)(function(t9) {
  var o4, i5, n6 = t9.width, r5 = t9.height, e7 = t9.type, l3 = t9.x, a4 = t9.y;
  return "cross" === e7 ? (o4 = { x0: l3, x1: l3, y0: 0, y1: r5 }, i5 = { x0: 0, x1: n6, y0: a4, y1: a4 }) : "top-left" === e7 ? (o4 = { x0: l3, x1: l3, y0: 0, y1: a4 }, i5 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "top" === e7 ? o4 = { x0: l3, x1: l3, y0: 0, y1: a4 } : "top-right" === e7 ? (o4 = { x0: l3, x1: l3, y0: 0, y1: a4 }, i5 = { x0: l3, x1: n6, y0: a4, y1: a4 }) : "right" === e7 ? i5 = { x0: l3, x1: n6, y0: a4, y1: a4 } : "bottom-right" === e7 ? (o4 = { x0: l3, x1: l3, y0: a4, y1: r5 }, i5 = { x0: l3, x1: n6, y0: a4, y1: a4 }) : "bottom" === e7 ? o4 = { x0: l3, x1: l3, y0: a4, y1: r5 } : "bottom-left" === e7 ? (o4 = { x0: l3, x1: l3, y0: a4, y1: r5 }, i5 = { x0: 0, x1: l3, y0: a4, y1: a4 }) : "left" === e7 ? i5 = { x0: 0, x1: l3, y0: a4, y1: a4 } : "x" === e7 ? o4 = { x0: l3, x1: l3, y0: 0, y1: r5 } : "y" === e7 && (i5 = { x0: 0, x1: n6, y0: a4, y1: a4 }), (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [o4 && (0, import_jsx_runtime3.jsx)(E2, { x0: o4.x0, x1: o4.x1, y0: o4.y0, y1: o4.y1 }), i5 && (0, import_jsx_runtime3.jsx)(E2, { x0: i5.x0, x1: i5.x1, y0: i5.y0, y1: i5.y1 })] });
});
...
var k3 = function() {
  var t9 = (0, import_react7.useContext)(N);
  if (void 0 === t9)
...
var Delaunator = class _Delaunator {
  ...
  update() {
    ...
    for (let k5 = 0, xp, yp; k5 < this._ids.length; k5++) {
      ...
      if (e7 === -1)
        continue;
      let t9 = this._addTriangle(e7, i5, hullNext[e7], -1, -1, hullTri[e7]);
      hullTri[i5] = this._legalize(t9 + 2);
      hullTri[e7] = t9;
      hullSize++;
      let n7 = hullNext[e7];
      while (q = hullNext[n7], orient(x4, y3, coords[2 * n7], coords[2 * n7 + 1], coords[2 * q], coords[2 * q + 1])) {
        t9 = this._addTriangle(n7, i5, q, hullTri[i5], -1, hullTri[n7]);
        hullTri[i5] = this._legalize(t9 + 2);
        hullNext[n7] = n7;
        hullSize--;
        n7 = q;
      ...
      if (e7 === start2) {
        while (q = hullPrev[e7], orient(x4, y3, coords[2 * q], coords[2 * q + 1], coords[2 * e7], coords[2 * e7 + 1])) {
          t9 = this._addTriangle(q, i5, e7, -1, hullTri[e7], hullTri[q]);
          this._legalize(t9 + 2);
          hullTri[q] = t9;
          hullNext[e7] = e7;
          hullSize--;
  ...
  _addTriangle(i0, i1, i22, a4, b5, c4) {
    const t9 = this.trianglesLen;
    this._triangles[t9] = i0;
    this._triangles[t9 + 1] = i1;
    this._triangles[t9 + 2] = i22;
    this._link(t9, a4);
    this._link(t9 + 1, b5);
    this._link(t9 + 2, c4);
    this.trianglesLen += 3;
...
var Voronoi = class {
  ...
  render(context) {
    ...
    for (let i5 = 0; i5 < hull.length; ++i5) {
      h0 = h1, h1 = hull[i5];
      const t9 = Math.floor(inedges[h1] / 3) * 2;
      const x4 = circumcenters[t9];
      const y3 = circumcenters[t9 + 1];
      const v5 = h0 * 4;
  ...
  *neighbors(i5) {
  ...
  _cell(i5) {
    ...
    let e7 = e0;
    do {
      const t9 = Math.floor(e7 / 3);
      points.push(circumcenters[t9 * 2], circumcenters[t9 * 2 + 1]);
      e7 = e7 % 3 === 2 ? e7 - 2 : e7 + 1;
      if (triangles[e7] !== i5)
        break;
      e7 = halfedges[e7];
  ...
  _project(x0, y0, vx, vy) {
    let t9 = Infinity, c4, x4, y3;
    if (vy < 0) {
      if (y0 <= this.ymin)
        return null;
      if ((c4 = (this.ymin - y0) / vy) < t9)
        y3 = this.ymin, x4 = x0 + (t9 = c4) * vx;
    } else if (vy > 0) {
      if (y0 >= this.ymax)
        return null;
      if ((c4 = (this.ymax - y0) / vy) < t9)
        y3 = this.ymax, x4 = x0 + (t9 = c4) * vx;
    }
    if (vx > 0) {
      if (x0 >= this.xmax)
        return null;
      if ((c4 = (this.xmax - x0) / vx) < t9)
        x4 = this.xmax, y3 = y0 + (t9 = c4) * vy;
    } else if (vx < 0) {
      if (x0 <= this.xmin)
        return null;
      if ((c4 = (this.xmin - x0) / vx) < t9)
        x4 = this.xmin, y3 = y0 + (t9 = c4) * vy;
    }
    return [x4, y3];
  }
  _edgecode(x4, y3) {
...
function collinear(d2) {
  ...
  for (let i5 = 0; i5 < triangles.length; i5 += 3) {
    const a4 = 2 * triangles[i5], b5 = 2 * triangles[i5 + 1], c4 = 2 * triangles[i5 + 2], cross = (coords[c4] - coords[a4]) * (coords[b5 + 1] - coords[a4 + 1]) - (coords[b5] - coords[a4]) * (coords[c4 + 1] - coords[a4 + 1]);
    if (cross > 1e-10)
      return false;
  }
  return true;
...
var Delaunay = class _Delaunay {
  ...
  *neighbors(i5) {
  ...
  find(x4, y3, i5 = 0) {
    ...
    const i0 = i5;
    let c4;
    while ((c4 = this._step(i5, x4, y3)) >= 0 && c4 !== i5 && c4 !== i0)
      i5 = c4;
    return c4;
  }
  _step(i5, x4, y3) {
    ...
    do {
      let t9 = triangles[e7];
      const dt = pow(x4 - points[t9 * 2], 2) + pow(y3 - points[t9 * 2 + 1], 2);
      if (dt < dc)
        dc = dt, c4 = t9;
      e7 = e7 % 3 === 2 ? e7 - 2 : e7 + 1;
      if (triangles[e7] !== i5)
...
var b4 = function(n6) {
  var e7 = n6.points, i5 = n6.x, o4 = void 0 === i5 ? "x" : i5, t9 = n6.y, r5 = void 0 === t9 ? "y" : t9, l3 = g4(o4), u2 = g4(r5);
  return e7.map(function(n7) {
    return [l3(n7), u2(n7)];
  });
};
var k4 = function(n6) {
  var e7 = n6.points, i5 = n6.width, o4 = n6.height, t9 = n6.debug, r5 = Delaunay.from(e7), l3 = t9 ? r5.voronoi([0, 0, i5, o4]) : void 0;
  return { delaunay: r5, voronoi: l3 };
};
var x3 = function(e7) {
  var i5 = e7.points, o4 = e7.x, t9 = e7.y, r5 = e7.width, l3 = e7.height, u2 = e7.debug, a4 = (0, import_react8.useMemo)(function() {
    return b4({ points: i5, x: o4, y: t9 });
  }, [i5, o4, t9]);
...
var P3 = function(e7) {
  var i5 = e7.nodes, l3 = e7.width, u2 = e7.height, a4 = e7.x, d2 = e7.y, c4 = e7.onMouseEnter, h3 = e7.onMouseMove, m3 = e7.onMouseLeave, y3 = e7.onClick, g5 = e7.debug, b5 = (0, import_react8.useRef)(null), k5 = (0, import_react8.useState)(null), C4 = k5[0], L2 = k5[1], w4 = x3({ points: i5, x: a4, y: d2, width: l3, height: u2, debug: g5 }), W3 = w4.delaunay, D2 = w4.voronoi, M = (0, import_react8.useMemo)(function() {
    if (g5 && D2)
      return D2.render();
  }, [g5, D2]), P4 = (0, import_react8.useCallback)(function(n6) {
    if (!b5.current)
      return [null, null];
    var e8 = Qi(b5.current, n6), o4 = e8[0], t9 = e8[1], r5 = W3.find(o4, t9);
    return [r5, void 0 !== r5 ? i5[r5] : null];
  }, [b5, W3]), O4 = (0, import_react8.useCallback)(function(n6) {
    var e8 = P4(n6), i6 = e8[0], o4 = e8[1];
    L2(i6), o4 && (null == c4 || c4(o4, n6));
  }, [P4, L2, c4]), S4 = (0, import_react8.useCallback)(function(n6) {
    var e8 = P4(n6), i6 = e8[0], o4 = e8[1];
    L2(i6), o4 && (null == h3 || h3(o4, n6));
  }, [P4, L2, h3]), j2 = (0, import_react8.useCallback)(function(n6) {
    if (L2(null), m3) {
      var e8 = void 0;
      null !== C4 && (e8 = i5[C4]), e8 && m3(e8, n6);
    }
  }, [L2, C4, m3, i5]), z2 = (0, import_react8.useCallback)(function(n6) {
    var e8 = P4(n6), i6 = e8[0], o4 = e8[1];
    L2(i6), o4 && (null == y3 || y3(o4, n6));
  }, [P4, L2, y3]);
  return (0, import_jsx_runtime4.jsxs)("g", { ref: b5, children: [g5 && D2 && (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [(0, import_jsx_runtime4.jsx)("path", { d: M, stroke: "red", strokeWidth: 1, opacity: 0.75 }), null !== C4 && (0, import_jsx_runtime4.jsx)("path", { fill: "pink", opacity: 0.35, d: D2.renderCell(C4) })] }), (0, import_jsx_runtime4.jsx)("rect", { width: l3, height: u2, fill: "red", opacity: 0, style: { cursor: "auto" }, onMouseEnter: O4, onMouseMove: S4, onMouseLeave: j2, onClick: z2 })] });
};
...
var oe = function(e7) {
  var r5 = e7.slice, i5 = e7.axis, n6 = Vt(), t9 = "x" === i5 ? "y" : "x";
  return (0, import_jsx_runtime5.jsx)(C3, { rows: r5.points.map(function(e8) {
    return [(0, import_jsx_runtime5.jsx)(b3, { color: e8.serieColor, style: n6.tooltip.chip }, "chip"), e8.serieId, (0, import_jsx_runtime5.jsx)("span", { style: n6.tooltip.tableCellValue, children: e8.data[t9 + "Formatted"] }, "value")];
  }) });
};
...
var he = function(e7) {
  var i5 = e7.curve, n6 = e7.yScale, t9 = e7.areaBaselineValue;
  return (0, import_react9.useMemo)(function() {
    return area_default().defined(function(e8) {
      ...
      return e8.y;
    }).curve(qt(i5)).y0(n6(t9));
  }, [i5, n6, t9]);
};
var ye = function(e7) {
  var i5 = e7.enableSlices, n6 = e7.points, t9 = e7.width, o4 = e7.height;
  return (0, import_react9.useMemo)(function() {
    if (false === i5)
      return [];
    if ("x" === i5) {
      ...
      return n6.forEach(function(r6) {
        ...
        return { id: a4, x0: n7 = l3 ? a4 - (a4 - l3[0]) / 2 : a4, x: a4, y0: 0, y: 0, width: u2 ? a4 - n7 + (u2[0] - a4) / 2 : t9 - n7, height: o4, points: s3.reverse() };
      });
    }
    if ("y" === i5) {
      ...
      return n6.forEach(function(e9) {
        ...
        return n7 = u2 ? s3 - (s3 - u2[0]) / 2 : s3, a4 = d2 ? s3 - n7 + (d2[0] - s3) / 2 : o4 - n7, { id: s3, x0: 0, x: 0, y0: n7, y: s3, width: t9, height: a4, points: l3.reverse() };
      });
    }
  }, [i5, n6]);
};
var be = function(e7) {
  var t9 = e7.data, o4 = e7.xScale, a4 = void 0 === o4 ? ce.xScale : o4, s3 = e7.xFormat, l3 = e7.yScale, d2 = void 0 === l3 ? ce.yScale : l3, c4 = e7.yFormat, f4 = e7.width, p5 = e7.height, h3 = e7.colors, b5 = void 0 === h3 ? ce.colors : h3, g5 = e7.curve, m3 = void 0 === g5 ? ce.curve : g5, v5 = e7.areaBaselineValue, x4 = void 0 === v5 ? ce.areaBaselineValue : v5, R = e7.pointColor, q = void 0 === R ? ce.pointColor : R, O4 = e7.pointBorderColor, S4 = void 0 === O4 ? ce.pointBorderColor : O4, C4 = e7.enableSlices, T4 = void 0 === C4 ? ce.enableSlicesTooltip : C4, M = Xt(s3), w4 = Xt(c4), W3 = dr(b5, "id"), G = Vt(), L2 = We(q, G), P4 = We(S4, G), j2 = (0, import_react9.useState)([]), F = j2[0], V3 = j2[1], E3 = (0, import_react9.useMemo)(function() {
    return dn(t9.filter(function(e8) {
      return -1 === F.indexOf(e8.id);
    }), a4, d2, f4, p5);
  }, [t9, F, a4, d2, f4, p5]), Y4 = E3.xScale, D2 = E3.yScale, X4 = E3.series, z2 = (0, import_react9.useMemo)(function() {
    var e8 = t9.map(function(e9) {
  ...
  }, [t9, X4, W3]), A3 = z2.legendData, H2 = z2.series, I = (0, import_react9.useCallback)(function(e8) {
    V3(function(r5) {
    ...
    var i5 = e8.series, n6 = e8.getPointColor, t10 = e8.getPointBorderColor, o5 = e8.formatX, a5 = e8.formatY;
    return (0, import_react9.useMemo)(function() {
      return i5.reduce(function(e9, r5) {
        return [].concat(e9, r5.data.filter(function(e10) {
          ...
          return l4.color = n6(r5), l4.borderColor = t10(l4), l4.data = ie({}, i6.data, { xFormatted: o5(i6.data.x), yFormatted: a5(i6.data.y) }), l4;
        }));
      }, []);
    }, [i5, n6, t10, o5, a5]);
  }({ series: H2, getPointColor: L2, getPointBorderColor: P4, formatX: M, formatY: w4 }), N3 = ye({ enableSlices: T4, points: K4, width: f4, height: p5 });
  return { legendData: A3, toggleSerie: I, lineGenerator: pe({ curve: m3 }), areaGenerator: he({ curve: m3, yScale: D2, areaBaselineValue: x4 }), getColor: W3, series: H2, xScale: Y4, yScale: D2, slices: N3, points: K4 };
};
var ge = function(e7) {
  var r5 = e7.areaBlendMode, i5 = e7.areaOpacity, n6 = e7.color, t9 = e7.fill, o4 = e7.path, a4 = tt(), s3 = a4.animate, l3 = a4.config, u2 = it(o4), d2 = useSpring({ color: n6, config: l3, immediate: !s3 });
  return (0, import_jsx_runtime5.jsx)(animated.path, { d: u2, fill: t9 || d2.color, fillOpacity: i5, strokeWidth: 0, style: { mixBlendMode: r5 } });
};
...
var me = function(e7) {
  var r5 = e7.areaGenerator, i5 = e7.areaOpacity, n6 = e7.areaBlendMode, t9 = e7.lines.slice(0).reverse();
  return (0, import_jsx_runtime5.jsx)("g", { children: t9.map(function(e8) {
...
var xe = function(e7) {
  var i5 = e7.lineGenerator, n6 = e7.points, t9 = e7.color, o4 = e7.thickness, a4 = (0, import_react9.useMemo)(function() {
    return i5(n6);
  }, [i5, n6]), s3 = it(a4);
  return (0, import_jsx_runtime5.jsx)(animated.path, { d: s3, fill: "none", strokeWidth: o4, stroke: t9 });
};
...
var qe2 = function(e7) {
  ...
  return r5.slice(0).reverse().map(function(e8) {
    var r6 = e8.id, t9 = e8.data, o4 = e8.color;
    return (0, import_jsx_runtime5.jsx)(Re2, { id: r6, points: t9.map(function(e9) {
      return e9.position;
...
var Se2 = function(e7) {
  var r5 = e7.slice, i5 = e7.axis, o4 = e7.debug, a4 = e7.tooltip, s3 = e7.isCurrent, l3 = e7.setCurrent, u2 = k3(), d2 = u2.showTooltipFromEvent, c4 = u2.hideTooltip, f4 = (0, import_react9.useCallback)(function(e8) {
...
var Te2 = function(e7) {
  var r5 = e7.slices, i5 = e7.axis, n6 = e7.debug, t9 = e7.height, o4 = e7.tooltip, a4 = e7.current, s3 = e7.setCurrent;
  return r5.map(function(e8) {
    return (0, import_jsx_runtime5.jsx)(Ce2, { slice: e8, axis: i5, debug: n6, height: t9, tooltip: o4, setCurrent: s3, isCurrent: null !== a4 && a4.id === e8.id }, e8.id);
  });
};
...
var we2 = function(e7) {
  var r5 = e7.points, i5 = e7.symbol, n6 = e7.size, t9 = e7.borderWidth, o4 = e7.enableLabel, a4 = e7.label, s3 = e7.labelYOffset, l3 = Vt(), d2 = Ei(a4), c4 = r5.reverse().map(function(e8) {
    return { id: e8.id, x: e8.x, y: e8.y, datum: e8.data, fill: e8.color, stroke: e8.borderColor, label: o4 ? d2(e8.data) : null };
  });
  return (0, import_jsx_runtime5.jsx)("g", { children: c4.map(function(e8) {
    return (0, import_jsx_runtime5.jsx)(Mi, { x: e8.x, y: e8.y, datum: e8.datum, symbol: i5, size: n6, color: e8.fill, borderWidth: t9, borderColor: e8.stroke, label: e8.label, labelYOffset: s3, theme: l3 }, e8.id);
  }) });
};
...
var ke = function(e7) {
  var r5 = e7.points, i5 = e7.width, o4 = e7.height, a4 = e7.margin, s3 = e7.setCurrent, l3 = e7.onMouseEnter, u2 = e7.onMouseMove, d2 = e7.onMouseLeave, c4 = e7.onClick, f4 = e7.tooltip, p5 = e7.debug, h3 = k3(), y3 = h3.showTooltipAt, b5 = h3.hideTooltip, g5 = (0, import_react9.useCallback)(function(e8, r6) {
...
var Ge2 = function(e7) {
  var r5 = e7.data, n6 = e7.xScale, t9 = e7.xFormat, a4 = e7.yScale, s3 = e7.yFormat, l3 = e7.layers, d2 = e7.curve, c4 = e7.areaBaselineValue, f4 = e7.colors, p5 = e7.margin, h3 = e7.width, y3 = e7.height, b5 = e7.axisTop, g5 = e7.axisRight, m3 = e7.axisBottom, v5 = e7.axisLeft, x4 = e7.enableGridX, C4 = e7.enableGridY, T4 = e7.gridXValues, M = e7.gridYValues, w4 = e7.lineWidth, B4 = e7.enableArea, W3 = e7.areaOpacity, P4 = e7.areaBlendMode, j2 = e7.enablePoints, F = e7.pointSymbol, E3 = e7.pointSize, Y4 = e7.pointColor, D2 = e7.pointBorderWidth, X4 = e7.pointBorderColor, z2 = e7.enablePointLabel, H2 = e7.pointLabel, I = e7.pointLabelYOffset, J2 = e7.defs, K4 = e7.fill, Q3 = e7.markers, U = e7.legends, Z = e7.isInteractive, $2 = e7.useMesh, _2 = e7.debugMesh, ee = e7.onMouseEnter, re = e7.onMouseMove, ne2 = e7.onMouseLeave, te2 = e7.onClick, oe2 = e7.tooltip, ae2 = e7.enableSlices, se2 = e7.debugSlices, le2 = e7.sliceTooltip, ue2 = e7.enableCrosshair, de2 = e7.crosshairType, ce2 = e7.role, fe2 = At(h3, y3, p5), pe2 = fe2.margin, he2 = fe2.innerWidth, ye2 = fe2.innerHeight, ge2 = fe2.outerWidth, me2 = fe2.outerHeight, xe2 = be({ data: r5, xScale: n6, xFormat: t9, yScale: a4, yFormat: s3, width: he2, height: ye2, colors: f4, curve: d2, areaBaselineValue: c4, pointColor: Y4, pointBorderColor: X4, enableSlices: ae2 }), Re3 = xe2.legendData, qe3 = xe2.toggleSerie, Se3 = xe2.lineGenerator, Ce3 = xe2.areaGenerator, Te3 = xe2.series, we3 = xe2.xScale, ke2 = xe2.yScale, Ge3 = xe2.slices, Le3 = xe2.points, Pe3 = Vt(), je2 = We(Y4, Pe3), Fe3 = We(X4, Pe3), Ve3 = (0, import_react9.useState)(null), Ee2 = Ve3[0], Ye2 = Ve3[1], De2 = (0, import_react9.useState)(null), Xe2 = De2[0], ze2 = De2[1], Ae = { grid: (0, import_jsx_runtime5.jsx)(B2, { theme: Pe3, width: he2, height: ye2, xScale: x4 ? we3 : null, yScale: C4 ? ke2 : null, xValues: T4, yValues: M }, "grid"), markers: (0, import_jsx_runtime5.jsx)(Bi, { markers: Q3, width: he2, height: ye2, xScale: we3, yScale: ke2, theme: Pe3 }, "markers"), axes: (0, import_jsx_runtime5.jsx)(X2, { xScale: we3, yScale: ke2, width: he2, height: ye2, theme: Pe3, top: b5, right: g5, bottom: m3, left: v5 }, "axes"), areas: null, lines: (0, import_jsx_runtime5.jsx)(Oe2, { lines: Te3, lineGenerator: Se3, lineWidth: w4 }, "lines"), slices: null, points: null, crosshair: null, mesh: null, legends: U.map(function(e8, r6) {
...
var je = function(e7) {
  var r5 = e7.width, o4 = e7.height, a4 = e7.margin, d2 = e7.pixelRatio, c4 = e7.data, f4 = e7.xScale, p5 = e7.xFormat, h3 = e7.yScale, y3 = e7.yFormat, b5 = e7.curve, g5 = e7.layers, m3 = e7.colors, v5 = e7.lineWidth, x4 = e7.enableArea, q = e7.areaBaselineValue, O4 = e7.areaOpacity, S4 = e7.enablePoints, C4 = e7.pointSize, w4 = e7.pointColor, B4 = e7.pointBorderWidth, k5 = e7.pointBorderColor, W3 = e7.enableGridX, G = e7.gridXValues, L2 = e7.enableGridY, F = e7.gridYValues, V3 = e7.axisTop, Y4 = e7.axisRight, D2 = e7.axisBottom, X4 = e7.axisLeft, A3 = e7.legends, H2 = e7.isInteractive, I = e7.debugMesh, J2 = e7.onMouseLeave, K4 = e7.onClick, Q3 = e7.tooltip, U = e7.canvasRef, Z = (0, import_react9.useRef)(null), $2 = At(r5, o4, a4), ne2 = $2.margin, te2 = $2.innerWidth, oe2 = $2.innerHeight, ae2 = $2.outerWidth, se2 = $2.outerHeight, le2 = Vt(), ue2 = (0, import_react9.useState)(null), de2 = ue2[0], ce2 = ue2[1], fe2 = be({ data: c4, xScale: f4, xFormat: p5, yScale: h3, yFormat: y3, width: te2, height: oe2, colors: m3, curve: b5, areaBaselineValue: q, pointColor: w4, pointBorderColor: k5 }), pe2 = fe2.lineGenerator, he2 = fe2.areaGenerator, ye2 = fe2.series, ge2 = fe2.xScale, me2 = fe2.yScale, ve2 = fe2.points, xe2 = x3({ points: ve2, width: te2, height: oe2, debug: I }), Re3 = xe2.delaunay, qe3 = xe2.voronoi;
  (0, import_react9.useEffect)(function() {
    ...
    e8.scale(d2, d2), e8.fillStyle = le2.background, e8.fillRect(0, 0, ae2, se2), e8.translate(ne2.left, ne2.top), g5.forEach(function(r6) {
      if ("function" == typeof r6 && r6({ ctx: e8, innerWidth: te2, innerHeight: oe2, series: ye2, points: ve2, xScale: ge2, yScale: me2, lineWidth: v5, lineGenerator: pe2, areaGenerator: he2, currentPoint: de2, setCurrentPoint: ce2 }), "grid" === r6 && le2.grid.line.strokeWidth > 0 && (e8.lineWidth = le2.grid.line.strokeWidth, e8.strokeStyle = le2.grid.line.stroke, W3 && C2(e8, { width: te2, height: oe2, scale: ge2, axis: "x", values: G }), L2 && C2(e8, { width: te2, height: oe2, scale: me2, axis: "y", values: F })), "axes" === r6 && V(e8, { xScale: ge2, yScale: me2, width: te2, height: oe2, top: V3, right: Y4, bottom: D2, left: X4, theme: le2 }), "areas" === r6 && true === x4 && (e8.save(), e8.globalAlpha = O4, he2.context(e8), ye2.forEach(function(r7) {
      ...
      })), "points" === r6 && true === S4 && C4 > 0 && ve2.forEach(function(r7) {
        e8.fillStyle = r7.color, e8.beginPath(), e8.arc(r7.x, r7.y, C4 / 2, 0, 2 * Math.PI), e8.fill(), B4 > 0 && (e8.strokeStyle = r7.borderColor, e8.lineWidth = B4, e8.stroke());
        ...
        A3.forEach(function(r7) {
          H(e8, ie({}, r7, { data: r7.data || i5, containerWidth: te2, containerHeight: oe2, theme: le2 }));
        });
      }
    });
  }, [Z, ae2, se2, g5, le2, pe2, ye2, ge2, me2, W3, G, L2, F, V3, Y4, D2, X4, A3, ve2, S4, C4, de2]);
  var Oe3 = (0, import_react9.useCallback)(function(e8) {
    ...
    if (!Ji(ne2.left, ne2.top, te2, oe2, i5, n6))
      return null;
    var t9 = Re3.find(i5 - ne2.left, n6 - ne2.top);
    return ve2[t9];
...
var Ee = (0, import_react9.forwardRef)(function(e7, r5) {
  return (0, import_jsx_runtime5.jsx)(ti, { children: function(i5) {
    var n6 = i5.width, t9 = i5.height;
    return (0, import_jsx_runtime5.jsx)(Ve2, ie({ width: n6, height: t9 }, e7, { ref: r5 }));
  } });
});
export {
  Le2 as Line,
