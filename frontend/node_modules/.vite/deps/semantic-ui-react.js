...
import {
  _createClass
} from "./chunk-ZKD6RJMW.js";
import {
  _inheritsLoose
} from "./chunk-SW6DXPYE.js";
import {
...
var createSimpleRange = function createSimpleRange2(start, end, pageFactory) {
...
var Visibility = function(_Component) {
  ...
  _proto.computeCalculations = function computeCalculations() {
    ...
    var _this$ref$current$get = this.ref.current.getBoundingClientRect(), bottom = _this$ref$current$get.bottom, height = _this$ref$current$get.height, top = _this$ref$current$get.top, width = _this$ref$current$get.width;
    var _normalizeOffset = normalizeOffset_default(offset), topOffset = _normalizeOffset[0], bottomOffset = _normalizeOffset[1];
...
var Form = function(_Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props, action = _this$props.action, children = _this$props.children, className = _this$props.className, error = _this$props.error, inverted = _this$props.inverted, loading = _this$props.loading, reply = _this$props.reply, size2 = _this$props.size, success = _this$props.success, unstackable = _this$props.unstackable, warning = _this$props.warning, widths = _this$props.widths;
    var classes = clsx_m_default("ui", size2, useKeyOnly(error, "error"), useKeyOnly(inverted, "inverted"), useKeyOnly(loading, "loading"), useKeyOnly(reply, "reply"), useKeyOnly(success, "success"), useKeyOnly(unstackable, "unstackable"), useKeyOnly(warning, "warning"), useWidthProp(widths, null, true), "form", className);
...
var Popup = function(_Component) {
  ...
  function Popup2() {
    ...
    _this.renderContent = function(_ref) {
      ...
      var _this$props2 = _this.props, basic = _this$props2.basic, children = _this$props2.children, className = _this$props2.className, content = _this$props2.content, hideOnScroll = _this$props2.hideOnScroll, flowing = _this$props2.flowing, header = _this$props2.header, inverted = _this$props2.inverted, popper = _this$props2.popper, size2 = _this$props2.size, style = _this$props2.style, wide = _this$props2.wide;
...
var Progress = function(_Component) {
  ...
  _proto.render = function render() {
    var _this$props7 = this.props, active = _this$props7.active, attached = _this$props7.attached, className = _this$props7.className, color = _this$props7.color, disabled = _this$props7.disabled, error = _this$props7.error, indicating = _this$props7.indicating, inverted = _this$props7.inverted, size2 = _this$props7.size, success = _this$props7.success, warning = _this$props7.warning;
...
var useEventListener = function useEventListener2(options) {
  ...
  var latestListener = React129.useRef(listener);
  latestListener.current = listener;
  var eventHandler = React129.useCallback(function(event) {
    return latestListener.current(event);
  }, []);
  var timeoutId = React129.useRef(void 0);
  if (true) {
...
var Sticky = function(_Component) {
  ...
  _proto.computeStyle = function computeStyle() {
    ...
    var _this$state = this.state, bottom = _this$state.bottom, bound = _this$state.bound, sticky = _this$state.sticky, top = _this$state.top;
    if (!sticky)
      return styleElement;
    return _extends({
      bottom: bound ? 0 : bottom,
      top: bound ? void 0 : top,
      width: this.triggerRect.width
    }, styleElement);
  };
  _proto.render = function render() {
    var _this$props = this.props, children = _this$props.children, className = _this$props.className;
    var _this$state2 = this.state, bottom = _this$state2.bottom, bound = _this$state2.bound, sticky = _this$state2.sticky;
    ...
    var elementClasses = clsx_m_default("ui", sticky && (bound ? "bound bottom" : "fixed"), sticky && !bound && (bottom === null ? "top" : "bottom"), "sticky");
