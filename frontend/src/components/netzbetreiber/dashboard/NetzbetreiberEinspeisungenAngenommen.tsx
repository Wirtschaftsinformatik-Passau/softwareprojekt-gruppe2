...
const NetzbetreiberEinspeisungenAnfrageAngenommen = () => {
  ...
  useEffect(() => {
    ...
    setStateOtherwiseRedirect(setData, "netzbetreiber/einspeisezusagen?prozess_status=Genehmigt&prozess_status=Abgenommen&prozess_status=InstallationAbgeschlossen",
  ...
  const handleRowClick = (params: { row: { anlage_id: SetStateAction<number>, prozess_status: SetStateAction<ProzessStatus> }; }) => {
    navigate(`/netzbetreiber/einspeisungen/${params.row.anlage_id}?prozess_status=${ProzessStatus.PlanErstellt}`);
  }
...
return (
    ...
    gap="0px">
        <Box gridColumn={"span 2"} m="20px">
         <Header title="Einspeisungsanträge" subtitle="Offene Einspeisungen, die bearbeitet werden können"/>
         </Box>
