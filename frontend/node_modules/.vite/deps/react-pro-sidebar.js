...
var ProSidebar = function(_a, ref) {
  ...
  var sidebarRef = ref || import_react.default.createRef();
  ...
  var widthStyle = width ? { width, minWidth: width } : {};
  var collapsedWidthStyle = collapsedWidth ? { width: collapsedWidth, minWidth: collapsedWidth } : {};
  var finalWidth = collapsed ? collapsedWidthStyle : widthStyle;
  (0, import_react.useEffect)(function() {
    setSidebarState(__assign(__assign({}, sidebarState), { collapsed, rtl, toggled }));
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      __assign({ ref: sidebarRef, className: classnames("pro-sidebar", className, breakPoint, { collapsed, rtl, toggled }), style: __assign(__assign({}, finalWidth), style) }, rest),
      import_react.default.createElement(
        "div",
        { className: "pro-sidebar-inner" },
        image ? import_react.default.createElement("img", { src: image, alt: "sidebar background", className: "sidebar-bg" }) : null,
        import_react.default.createElement("div", { className: "pro-sidebar-layout" }, children)
      ),
      import_react.default.createElement("div", { className: "overlay", onClick: handleToggleSidebar, onKeyPress: handleToggleSidebar, role: "button", tabIndex: 0, "aria-label": "overlay" })
    )
  );
};
var ProSidebar$1 = (0, import_react.forwardRef)(ProSidebar);
var SidebarHeader = function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  var sidebarHeaderRef = ref || import_react.default.createRef();
  return import_react.default.createElement("div", __assign({ ref: sidebarHeaderRef, className: classnames("pro-sidebar-header", className) }, rest), children);
};
var SidebarHeader$1 = (0, import_react.forwardRef)(SidebarHeader);
var SidebarContent = function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  var sidebarContentRef = ref || import_react.default.createRef();
  return import_react.default.createElement("div", __assign({ ref: sidebarContentRef, className: classnames("pro-sidebar-content", className) }, rest), children);
};
var SidebarContent$1 = (0, import_react.forwardRef)(SidebarContent);
var SidebarFooter = function(_a, ref) {
  var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
  var sidebarFooterRef = ref || import_react.default.createRef();
  return import_react.default.createElement("div", __assign({ ref: sidebarFooterRef, className: classnames("pro-sidebar-footer", className) }, rest), children);
};
var SidebarFooter$1 = (0, import_react.forwardRef)(SidebarFooter);
var Menu = function(_a, ref) {
  ...
  var menuRef = ref || import_react.default.createRef();
  return import_react.default.createElement(
    "nav",
    __assign({ ref: menuRef, className: classnames("pro-menu", className, (_b = {}, _b["shaped " + iconShape] = ["square", "round", "circle"].indexOf(iconShape) >= 0, _b["submenu-bullets"] = subMenuBullets, _b["inner-submenu-arrows"] = innerSubMenuArrows, _b)) }, rest),
    import_react.default.createElement("ul", null, import_react.default.Children.toArray(children).filter(Boolean).map(function(child, index2) {
...
var Menu$1 = (0, import_react.forwardRef)(Menu);
var MenuItem = function(_a, ref) {
  ...
  var menuItemRef = ref || import_react.default.createRef();
  return import_react.default.createElement(
    "li",
    __assign({ ref: menuItemRef, className: classnames("pro-menu-item", className, { active }) }, rest),
    import_react.default.createElement(
      "div",
      { className: "pro-inner-item", tabIndex: 0, role: "button" },
      icon ? import_react.default.createElement(
        "span",
        { className: "pro-icon-wrapper" },
        import_react.default.createElement("span", { className: "pro-icon" }, icon)
      ) : null,
      prefix ? import_react.default.createElement("span", { className: "prefix-wrapper" }, prefix) : null,
      import_react.default.createElement("span", { className: "pro-item-content" }, children),
      suffix ? import_react.default.createElement("span", { className: "suffix-wrapper" }, suffix) : null
    )
  );
};
var MenuItem$1 = (0, import_react.forwardRef)(MenuItem);
var slidedown = createCommonjsModule(function(module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  var react_1 = tslib_es6.__importStar(import_react.default);
  var SlideDownContent = function(_super) {
    tslib_es6.__extends(SlideDownContent2, _super);
  ...
  exports.SlideDown = react_1.forwardRef(function(props, ref) {
    return react_1.default.createElement(SlideDownContent, tslib_es6.__assign({}, props, { forwardedRef: ref }));
  });
...
var SubMenu = function(_a, ref) {
  ...
  var popperInstance;
  var _c = (0, import_react.useContext)(SidebarContext), collapsed = _c.collapsed, rtl = _c.rtl, toggled = _c.toggled;
  var _d = (0, import_react.useState)(!defaultOpen), closed = _d[0], setClosed = _d[1];
  var popperElRef = (0, import_react.useRef)(null);
  var referenceElement = (0, import_react.useRef)(null);
  var popperElement = (0, import_react.useRef)(null);
  ...
  var subMenuRef = ref || import_react.default.createRef();
  return import_react.default.createElement(
    "li",
    __assign({ ref: subMenuRef, className: classnames("pro-menu-item pro-sub-menu", className, {
      open: typeof open === "undefined" ? !closed : open
    }) }, rest),
    import_react.default.createElement(
      "div",
      { ref: referenceElement, className: "pro-inner-item", onClick: handleToggleSubMenu, onKeyPress: handleToggleSubMenu, role: "button", tabIndex: 0 },
      icon ? import_react.default.createElement(
        "span",
        { className: "pro-icon-wrapper" },
        import_react.default.createElement("span", { className: "pro-icon" }, icon)
      ...
      prefix ? import_react.default.createElement("span", { className: "prefix-wrapper" }, prefix) : null,
      import_react.default.createElement("span", { className: "pro-item-content" }, title),
      suffix ? import_react.default.createElement("span", { className: "suffix-wrapper" }, suffix) : null,
      import_react.default.createElement(
        "span",
        { className: "pro-arrow-wrapper" },
        import_react.default.createElement("span", { className: "pro-arrow" })
      )
    ),
    firstchild && collapsed ? import_react.default.createElement(
      "div",
      { ref: popperElement, className: classnames("pro-inner-list-item popper-element", { "has-arrow": popperarrow }) },
      import_react.default.createElement(
        "div",
        { className: "popper-inner", ref: popperElRef },
        import_react.default.createElement("ul", null, children)
      ),
      popperarrow ? import_react.default.createElement("div", { className: "popper-arrow", "data-popper-arrow": true }) : null
    ) : import_react.default.createElement(
      SlideDown,
      { closed: typeof open === "undefined" ? closed : !open, className: "pro-inner-list-item" },
      import_react.default.createElement(
        "div",
        null,
        import_react.default.createElement("ul", null, children)
...
var SubMenu$1 = (0, import_react.forwardRef)(SubMenu);
export {
  Menu$1 as Menu,
  MenuItem$1 as MenuItem,
  ProSidebar$1 as ProSidebar,
  SidebarContent$1 as SidebarContent,
  SidebarFooter$1 as SidebarFooter,
  SidebarHeader$1 as SidebarHeader,
  SubMenu$1 as SubMenu
};
